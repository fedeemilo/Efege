		...
		<Container>
			<Media className='contenedor-nosotros'>
				<Row>
					...
					<Col xs='12' md='12' lg='6'>
						<Media body className='text-center text-adjust mt-n4'>
			...
			<Media tag='li' style={{marginTop: '15rem'}}>
				<Row className='mt-5 fila-del-medio'>
					<Col xs='12' md='12' lg='6' >'
						<Media body className='media-text text-center text-adjust w-100 mt-n4'>
							<Media heading className='color-brand font-weight-bold'>
								Somos Creativos
							</Media>
			...
			<Media style={{marginTop: '15rem'}}>
				<Row className='mt-5 mb-5'>
					...
					<Col xs='12' md='12' lg='6'>
						<Media body className='text-center text-adjust mt-n5'>
